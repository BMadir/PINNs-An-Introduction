...
class Nourgaliev:
    ...
    def rhs(self, t, x, y, lib=np):
        ...
        u1 = self.u1(t, x, y, lib=lib)
        u2 = self.u2(t, x, y, lib=lib)
        T = self.T(t, x, y, lib=lib)
